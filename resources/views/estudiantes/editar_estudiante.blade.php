@extends('layouts.layout')
	...
	<section id="contact">
		<div class="container">
			...
			<div class="col-md-12">
				<h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">Editar<span> estudiante</span>
				</h2>
			</div>
			<div class="align-self-xl-center" data-wow-offset="50" data-wow-delay="0.9s">
				...
				{{ csrf_field() }}
					...
					<input type="text" name="matricula" value="{{ $estudiante->matricula }}" class="form-control">
					...
					<input type="text" name="app" value="{{ $estudiante->app }}" class="form-control">
                    <p>@if($errors->first('app')) <i class="form-control">{{$errors->first('app')}}</i>@endif</p>
                    <label>APELLIDO MATERNO</label>
					<input type="text" name="apm" value="{{ $estudiante->apm }}" class="form-control">
